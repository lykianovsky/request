import { RequestExchange } from './request';
import { ResponseExchange } from './response';
/**
 ...
 */
export declare function executeExchanges<Exchange extends RequestExchange[] | ResponseExchange[], Input extends Parameters<Exchange[0]>[0]>(exchanges: Exchange, input: Input): Promise<Input>;
